...
<div class="wrapper">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{route('admin.crooms.create')}}" class="nav-link">
                                        <i class="fa fa-circle-o nav-icon"></i>
                                        <p>ثبت کلاس</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{route('admin.crooms.index')}}" class="nav-link">
                                        <i class="fa fa-circle-o nav-icon"></i>
                                        <p>لیست کلاس ها</p>
                                    </a>
                                </li>
    ...
    <footer class="main-footer">
        <strong>CopyLeft &copy; 2022 <a href="http://github.com/hesammousavi/"> </a>.</strong>
    </footer>
...
<!-- FastClick -->
<script src="{{asset('admin/plugins/fastclick/fastclick.j')}}s"></script>
<!-- AdminLTE App -->
